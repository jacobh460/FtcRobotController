...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = (12.1784492+12.174924+12.168971)/3.0; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.9; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, frontEncoder;
    public static double X_MULTIPLIER = 1.0171107;
    public static double Y_MULTIPLIER = (90.0/88.0780057160976+90.0/88.01812061937896+90.0/88.11537442748674)/3.0;
